...
def transformProduct(t1, t2):
    '''
    Get the transform product between two transforms.
    '''
    trans1, rot1= t1
...
class Fetch_Robot():
    ...
    def generate_seed_state(self, numOfJoints):
        '''generate the seed for the robot arm'''
        result = []
    ...
    def solve_ik_sollision_free_in_base(self, transform, numOfAttempt):
        '''
        find the collision-free ik solution.
        '''
    ...
    def is_state_valid(self, checked_robot_state):
        '''
        check whether current state is collision-free.
        '''
    ...
    def moveToFrame(self, transform, isInBaselink=True):
        '''
        Move the end-effector to the target pose with cartisian motion controller.
        '''
